<script lang="ts">
	...
	let { placeholder = 'Search', onSubmit, onSend, noShadow = false }: { placeholder?: string; onSubmit?: (value: string) => void; onSend?: (value: string) => void; noShadow?: boolean } = $props();
...
<div
	...
	style="
		...
		{noShadow ? '' : 'box-shadow: 0px 4px 40px 0px #DDC2FF, 0px 4px 40px 0px #E3F0FF, 0px 4px 40px 0px #FF59B43B;'}
	"
>
