	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				custom:
					'rounded-full px-6! py-6! text-sm font-medium transition-opacity bg-primary text-primary-foreground hover:bg-primary/80',
				customSecondary:
					'rounded-full px-6! py-6! text-sm font-medium transition-opacity bg-secondary text-secondary-foreground hover:bg-secondary/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground'
			},
			size: {
				default:
