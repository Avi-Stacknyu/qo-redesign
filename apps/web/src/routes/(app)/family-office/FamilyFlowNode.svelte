...
<Handle
	...
	isConnectable={true}
	style="width: 14px; height: 14px; background: oklch(var(--background)); border: 2px solid oklch(var(--primary)); pointer-events: all; cursor: crosshair; z-index: 10; opacity: 1;"
/>
		...
		<div class="p-4">
			...
			{#if data.responsibilities && data.responsibilities.length > 0}
				<div class="mt-2.5 flex flex-wrap gap-1">
					{#each data.responsibilities.slice(0, 3) as r}
