...
<div class="space-y-8">
	...
	{#if authMethods?.email && otpMode === 'idle'}
		<form {...signUp} class="space-y-4">
			...
			<button
				type="submit"
				class="mt-4 flex h-12 w-full items-center justify-center gap-x-2 rounded-full bg-[#1e8558] px-6 text-sm font-bold text-white shadow-md transition-all duration-200 hover:bg-[#186e48] hover:shadow-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-700 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100"
	...
	{#if otpMode === 'idle'}
		...
		<p class="mt-8 text-center text-sm text-slate-600">
			...
			<a href="/login" class="font-bold text-[#1e8558] hover:text-[#186e48] hover:underline">
				Login here!
			</a>
		</p>
	{/if}
