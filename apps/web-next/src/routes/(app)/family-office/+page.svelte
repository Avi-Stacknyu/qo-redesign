	...
	{:else if browser && isInitialized}
		...
		>
			<SvelteFlow
				...
				connectionLineStyle="stroke: var(--primary); stroke-width: 2;"
			>
...
<style>
	...
	:global(.svelte-flow__background pattern) {
		color: color-mix(in oklch, var(--border) 40%, transparent);
	}
	...
	:global(.svelte-flow__controls button) {
		...
		border-bottom-color: color-mix(in oklch, var(--border) 20%, transparent);
