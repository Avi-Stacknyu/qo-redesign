...
<div class="w-full max-w-lg mx-auto">
  ...
  <div class="mb-8 text-center">
    <h1 class="text-[40px] font-semibold tracking-[-0.03em] text-white">Welcome back</h1>
  ...
  {#if authMethods?.email && otpMode === 'idle'}
    <form {...signIn} class="space-y-5">
      <!-- EMAIL -->
      <div class="space-y-2">
        <Label for="email" class="text-[13px] font-medium text-slate-300">Work email</Label>
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <Label for="_password" class="text-[13px] font-medium text-slate-300">Password</Label>

          <a href="/forgot-password" class="text-[13px] text-slate-400 hover:text-white">
            Forgot password?
          </a>
        </div>
  ...
  {#if otpMode === 'request' && authMethods?.otp}
    ...
    <form class="space-y-5" {...requestOTP}>
      <div class="space-y-2">
        <Label class="text-[13px] font-medium text-slate-300">Email address</Label>
...
<div class="mb-6 flex items-center gap-4">
    ...
    <p class="mt-10 text-center text-[13px] leading-relaxed text-slate-400">
      ...
      <a href="/register" class="font-semibold text-white underline underline-offset-2">
        Register
      </a>
    </p>
  {/if}
