...
<div class="space-y-8">
	...
	{#if authMethods?.email && otpMode === 'idle'}
		<form {...signUp} class="space-y-4">
			...
			<button
				type="submit"
				class="mt-4 flex h-12 w-full items-center justify-center gap-x-2 rounded-full bg-[#7c3aed] px-6 text-sm font-bold text-white shadow-md transition-all duration-200 hover:bg-[#6d28d9] hover:shadow-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-700 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100"
