/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb32bf55d3687e4a64f66b651af41d3a)
// Runtime types generated with workerd@1.20260420.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		ASSETS: Fetcher;
		QUANT_AGENT: DurableObjectNamespace /* QuantPMAgent from quant-orion-worker */;
		ONBOARDING_SESSION: DurableObjectNamespace /* OnboardingSessionDO from quant-orion-worker */;
		CF_WORKER: Fetcher /* quant-orion-worker */;
		FILE_SERVICE: Service /* entrypoint FileServiceEntrypoint from quant-orion-worker */;
	}
}
