 ...
 *
 * Canonical source: extracted from apps/cf-worker/src/types/flow.ts
 *
 * ARCHITECTURE:
...
export interface ExecutionContext {
  ...
  chatId?: string;
  agentId: string;
  /** The record ID of the agent (for cost tracking relations) */
...
export type StreamEvent =
  | { type: 'status'; data: { phase: string; nodeId?: string } }
